...
public class WhenToWork {
    ...
    public static HashMap<String, Integer> getFreeDays(String statecode, int year) throws IOException {
    ...
    public static HashMap<String, Integer> getFreeDaysBetweenYears(String statecode, int start_year, int end_year) throws IOException {
